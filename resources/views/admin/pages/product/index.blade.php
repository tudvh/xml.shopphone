...
<div class="d-flex flex-column gap-4">
    ...
    <div class="d-flex justify-content-end gap-3">
        <a href="{{ route('admin.products.create') }}" class="btn btn-success gap-2">
            <i class="fa-solid fa-plus"></i>
            <span>Thêm mới</span>
        </a>
        <a href="{{ route('admin.products.exportXml') }}" class="btn btn-info gap-2" target="_blank">
            <i class="fa-regular fa-file-export"></i>
            <span>Xuất XML</span>
        </a>
        <a href="{{ route('admin.products.createByXml') }}" class="btn btn-info gap-2">
            <i class="fa-solid fa-plus"></i>
                ...
                <tr>
                    ...
                    <td>
                        <div class='d-flex justify-content-center align-items-center gap-2'>
                            <a href="{{ route('admin.products.edit', ['product' => $product->id]) }}" class='btn btn-primary' title="Cập nhật">
